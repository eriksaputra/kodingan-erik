...
<html lang="en">
  ...
  <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
    <div class="navbar-nav">
      ...
      <a class="nav-item nav-link" href="ulangan.php">Data Pembeli</a>
    ...
    <div class="row" style="padding:35px;">
        <div class="col-md-12">
            <div class="card badge-danger">
                <div class="card-header"><center><h1>Selamat Datang Di Erick Store</h1></center></div>
                <div class="card-body">
                <!-- ISI DISINI -->
                <div class="form-group badge-primary">
                  <center><h2>Di Store kami menyediakan berbagai merk sepatu futsal</h2></center>
                </div>
