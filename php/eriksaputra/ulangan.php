    ...
    <div class="row" style="padding:35px;">
        <div class="col-md-12">
            <div class="card badge-dark">
                ...
                <div class="form-group">
                    <textarea name="alamat[]" class="form-control" rows="4" placeholder="Alamat" id="alamat" Required></textarea>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    <button type="submit" name="simpan" class="byn btn-danger btn-block">Input Data</button>
                </div>
                </form>
                </div>
            </div>
